 ...
 <!-- images loaded -->
 <script type="text/javascript" src="{{asset('theme/js/imagesloaded.pkgd.min.js')}}"></script>
 <!-- pull menu -->
 ...
 <!-- revolution -->
 <script type="text/javascript" src="{{asset('theme/revolution/js/jquery.themepunch.tools.min.jss')}}"></script>
